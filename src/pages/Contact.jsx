...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      ...
      formElement,        // Use the form element instead of the ID string
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>8778135882</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <span className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>boopathi23101999@gmail.com</span>
                </div>
              </div>
            </div>
